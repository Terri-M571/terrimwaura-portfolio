          ...
          <div className="exp-tools-grid">
            ...
            <div className="reveal-right">
              ...
              <div className="tools-grid">
                ...
                <div className="tool-card"><div className="tool-icon">✨</div><div className="tool-name">After Effects</div><div className="tool-bar-wrap"><div className="tool-bar-fill" style={{ width: '75%' }}></div></div><div className="tool-pct">75%</div><div class="tool-cat">Motion</div></div>
        ...
        <div className="container">
          ...
          <div className={`gallery-panel ${activePanel === 'publications' ? 'open' : ''}`} id="panel-publications">
            ...
            <div className="pub-grid">
              ...
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#0468fb' }}><span>🛡️</span><div className="pub-type-badge">Capacity Statement</div></div><div className="pub-body"><div className="pub-title">Child Protection &amp; Participation</div><div className="pub-desc">Capacity statement highlighting expertise in child protection and participation across the East Africa region.</div><div className="pub-footer"><span class="pub-org">WV East Africa · 2024</span><span class="pub-arrow">↗</span></div></div></a>
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#024ebc' }}><span>💼</span><div className="pub-type-badge">Capacity Statement</div></div><div className="pub-body"><div class="pub-title">Economic Empowerment &amp; Livelihoods</div><div className="pub-desc">Documenting capabilities and impact in economic empowerment and sustainable livelihoods programmes.</div><div className="pub-footer"><span className="pub-org">WV East Africa · 2024</span><span className="pub-arrow">↗</span></div></div></a>
              ...
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#FB9704' }}><span>🚨</span><div className="pub-type-badge">Capacity Statement</div></div><div class="pub-body"><div className="pub-title">Humanitarian &amp; Emergency Affairs</div><div className="pub-desc">Showcasing humanitarian response capabilities and emergency preparedness expertise.</div><div className="pub-footer"><span className="pub-org">WV East Africa · 2024</span><span className="pub-arrow">↗</span></div></div></a>
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#0468fb' }}><span>🕊️</span><div className="pub-type-badge">Capacity Statement</div></div><div className="pub-body"><div className="pub-title">Peacebuilding &amp; Conflict Sensitivity</div><div className="pub-desc">Highlighting peacebuilding approaches and conflict-sensitive programming work.</div><div class="pub-footer"><span className="pub-org">WV East Africa · 2024</span><span className="pub-arrow">↗</span></div></div></a>
              ...
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#024ebc' }}><span>🗺️</span><div class="pub-type-badge">Regional Brief</div></div><div className="pub-body"><div class="pub-title">Regional Context Overview</div><div className="pub-desc">Strategic overview of the regional context and programming landscape across East Africa.</div><div className="pub-footer"><span className="pub-org">WV East Africa · 2024</span><span class="pub-arrow">↗</span></div></div></a>
              ...
              <a href="https://drive.google.com/drive/folders/1cr8jybFZdQkifaln0XGDoPse9YW_JFrq?usp=drive_link" target="_blank" rel="noopener noreferrer" className="pub-card"><div className="pub-cover" style={{ background: '#0468fb' }}><span>💧</span><div class="pub-type-badge">Capacity Statement</div></div><div className="pub-body"><div class="pub-title">WASH Capacity Statement</div><div class="pub-desc">Water, Sanitation and Hygiene capacity documenting programme expertise and community impact.</div><div class="pub-footer"><span className="pub-org">WV East Africa · 2024</span><span class="pub-arrow">↗</span></div></div></a>
            </div>
          </div>
            ...
            <div className="video-grid">
              ...
              <div className="video-card">
                ...
                <div className="video-info">
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '8px', flexWrap: 'wrap', gap: '8px' }}>
                    <div className="video-tags"><span className="video-tag">Storytelling</span><span class="video-tag">Campaign</span></div>
